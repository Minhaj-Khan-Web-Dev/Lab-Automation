      ...
      <div class="container-login100">
        <div class="wrap-login100">
          <form class="login100-form validate-form"  method="post">
            <span class="login100-form-title p-b-43" > Please Create Your Account  </span>
            <div
              class="wrap-input100 validate-input"
              data-validate="Name is required"
            >
              <input class="input100" name="cust_name" type="text" />
            ...
            >
              <input class="input100" name="cust_email" type="text" />
              <span class="focus-input100"></span>
            ...
            >
              <input class="input100" name="cust_dob" type="date" />
              <span class="focus-input100"></span>
            ...
            <div class="container-login100-form-btn">
              <button type="submit" name="btnsave" class="login100-form-btn">Create Account</button>
            </div>
...
if(isset($_POST['btnsave'])){
  ...
  $sql = "INSERT INTO `customers`( `cust_name`, `cust_email`, `cust_dob`, `cust_password`) VALUES ('$cust_name','$cust_email','$cust_dob','$cust_password')";
